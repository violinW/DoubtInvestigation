...
public class culcCash3 {
	...
	public static dtType culcProfite(int days, double remainCloudBill, double madeMoney, double cash, double lastMadeCush) {
		...
		if((int)d == d & d > 0) {
			...
			System.out.println("remainCloudBill round " + (int)d + ": " + dt.remainCloudBill + ", canCush: " + canCush + ", cush: " + dt.cash + ", madeMoney: " + dt.madeMoney);
		}
		if(days > 0) {
